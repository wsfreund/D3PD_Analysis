#define myAnalysisZee_cxx
#include "myAnalysisZee.h"
...
TFile *outFile;
Double_t NNCut_electronsvsjets = 0.0770;
//Double_t NNCut_loose = -0.13402000;
//Double_t NNCut_medium = 0.46830001;
//Double_t NNCut_tight = 0.80194002;

Double_t NNCut_loose = -0.12898000;
Double_t NNCut_medium = 0.53868002;
Double_t NNCut_tight = 0.86255997;



void myAnalysisZee::Loop(const char *hist_title){
   ...
   */
   ...
   TH1F *electrons_et_hist = new TH1F("Zee", "E_{T} no requirement", 100, 0, 200.);
   TH1F *jets_et_hist      = new TH1F("JetTauMiss", "E_{T} no requirement", 100, 0, 200.);
...
// NeuralNetwork Output Graph
...
#else
   TH1F *electrons_et_distribution = new TH1F("Et distribution for electrons","E_{t} distribution for electrons",100,0.,200.);
   TH1F *jets_et_distribution = new TH1F("Et distribution for jets","E_{t} distribution for jets",100,0.,200.);
   //Et CaloRinger 
   TH1F *caloRinger_optimal_dist_ele_et = new TH1F("Et distribution for electrons passed CaloRinger optimal requirement","E_{t} distribution for electrons pased CaloRinger optimal requirement",100,0.,200.);
   TH1F *caloRinger_loose_dist_ele_et = new TH1F("Et distribution for electrons passed CaloRinger loose requirement","E_{t} distribution for electrons pased CaloRinger loose requirement",100,0.,200.);
   TH1F *caloRinger_medium_dist_ele_et = new TH1F("Et distribution for electrons passed CaloRinger medium requirement","E_{t} distribution for electrons pased CaloRinger medium requirement",100,0.,200.);
   TH1F *caloRinger_tight_dist_ele_et = new TH1F("Et distribution for electrons passed CaloRinger tight requirement","E_{t} distribution for electrons pased CaloRinger tight requirement",100,0.,200.);
   TH1F *caloRinger_optimal_dist_jet_et = new TH1F("Et distribution for jets passed CaloRinger optimal requirement","E_{t} distribution for jets pased CaloRinger optimal requirement",100,0.,200.);
   TH1F *caloRinger_loose_dist_jet_et = new TH1F("Et distribution for jets passed CaloRinger loose requirement","E_{t} distribution for jets pased CaloRinger loose requirement",100,0.,200.);
   TH1F *caloRinger_medium_dist_jet_et = new TH1F("Et distribution for jets passed CaloRinger medium requirement","E_{t} distribution for jets pased CaloRinger medium requirement",100,0.,200.);
   TH1F *caloRinger_tight_dist_jet_et = new TH1F("Et distribution for jets passed CaloRinger tight requirement","E_{t} distribution for jets pased CaloRinger tight requirement",100,0.,200.);
   //Et regular Egamma 
   TH1F *regularEgamma_loose_dist_ele_et = new TH1F("Et distribution for electrons passed Regular E/#gamma loose requirement","E_{t} distribution for electrons pased Regular E/#gamma loose requirement",100,0.,200.);
   TH1F *regularEgamma_medium_dist_ele_et = new TH1F("Et distribution for electrons passed Regular E/#gamma medium requirement","E_{t} distribution for electrons pased Regular E/#gamma medium requirement",100,0.,200.);
   TH1F *regularEgamma_tight_dist_ele_et = new TH1F("Et distribution for electrons passed Regular E/#gamma tight requirement","E_{t} distribution for electrons pased Regular E/#gamma tight requirement",100,0.,200.);
   TH1F *regularEgamma_loose_dist_jet_et = new TH1F("Et distribution for jets passed Regular E/#gamma loose requirement","E_{t} distribution for jets pased Regular E/#gamma loose requirement",100,0.,200.);
   TH1F *regularEgamma_medium_dist_jet_et = new TH1F("Et distribution for jets passed Regular E/#gamma medium requirement","E_{t} distribution for jets pased Regular E/#gamma medium requirement",100,0.,200.);
   TH1F *regularEgamma_tight_dist_jet_et = new TH1F("Et distribution for jets passed Regular E/#gamma tight requirement","E_{t} distribution for jets pased Regular E/#gamma tight requirement",100,0.,200.);
#endif
   ...
   corr_bc_folder->mkdir("Zee_JetTauMiss");
   corr_bc_folder->cd("Zee_JetTauMiss");
   TH2F *corr_rcore_out_bc_all = new TH2F((string(hist_title)+"bc_rcore_all").c_str(), "Zee + JetTauMiss NO Requirement;rCore;Likelihood by NN     ", 100, 0., 1.2, 100, -1.00, 1.00);
   corr_rcore_out_bc_all->SetOption("COLZ");
   TH2F *corr_eratio_out_bc_all = new TH2F((string(hist_title)+"bc_eratio_all").c_str(), "Zee + JetTauMiss NO Requirement;eRatio;Likelihood by NN     ", 100, 0., 1.02, 100, -1.00, 1.00);
   corr_eratio_out_bc_all->SetOption("COLZ");
   TH2F *corr_eoverp_out_bc_all = new TH2F((string(hist_title)+"bc_eoverp_all").c_str(), "Zee + JetTauMiss NO Requirement;#frac{E}{p};Likelihood by NN     ", 100, 0., 4., 100, -1.00, 1.00);
   corr_eoverp_out_bc_all->SetOption("COLZ");
   TH2F *corr_hadleakage_out_bc_all = new TH2F((string(hist_title)+"bc_hadleakage_all").c_str(), "Zee + JetTauMiss NO Requirement;1^{st} Samp HAD Leakage;Likelihood by NN     ", 100, -250, 250, 100, -1.00, 1.00);
   corr_hadleakage_out_bc_all->SetOption("COLZ");
   TH2F *corr_width1_out_bc_all = new TH2F((string(hist_title)+"bc_width1_all").c_str(), "Zee + JetTauMiss NO Requirement;Width 1^{st} Samp;Likelihood by NN     ", 100, .0, 1., 100, -1.00, 1.00);
   corr_width1_out_bc_all->SetOption("COLZ");
   TH2F *corr_width2_out_bc_all = new TH2F((string(hist_title)+"bc_width2_all").c_str(), "Zee + JetTauMiss NO Requirement;Width 2^{nd} Samp;Likelihood by NN     ", 100, -.02, .06, 100, -1.00, 1.00);
   corr_width2_out_bc_all->SetOption("COLZ");
   // Electrons with no requirement:
   corr_bc_folder->mkdir("Zee_noreq");
   corr_bc_folder->cd("Zee_noreq");
   TH2F *corr_rcore_out_bc_electron_all = new TH2F((string(hist_title)+"bc_rcore_electron_noreq").c_str(), "Zee NO Requirement;rCore;Likelihood by NN     ", 100, 0., 1.2, 100, -1.00, 1.00);
   corr_rcore_out_bc_electron_all->SetOption("COLZ");
   TH2F *corr_eratio_out_bc_electron_all = new TH2F((string(hist_title)+"bc_eratio_electron_all").c_str(), "Zee NO Requirement;eRatio;Likelihood by NN     ", 100, 0., 1.02, 100, -1.00, 1.00);
   corr_eratio_out_bc_electron_all->SetOption("COLZ");
   TH2F *corr_eoverp_out_bc_electron_all = new TH2F((string(hist_title)+"bc_eoverp_electron_all").c_str(), "Zee NO Requirement;#frac{E}{p};Likelihood by NN     ", 100, 0., 4., 100, -1.00, 1.00);
   corr_eoverp_out_bc_electron_all->SetOption("COLZ");
   TH2F *corr_hadleakage_out_bc_electron_all = new TH2F((string(hist_title)+"bc_hadlakage_electron_all").c_str(), "Zee NO Requirement;1^{st} Samp HAD Leakage;Likelihood by NN     ", 100, -250, 250, 100, -1.00, 1.00);
   corr_hadleakage_out_bc_electron_all->SetOption("COLZ");
   TH2F *corr_width1_out_bc_electron_all = new TH2F((string(hist_title)+"bc_width1_electron_all").c_str(), "Zee NO Requirement;Width 1^{st} Samp;Likelihood by NN     ", 100, .0, 1., 100, -1.00, 1.00);
   corr_width1_out_bc_electron_all->SetOption("COLZ");
   TH2F *corr_width2_out_bc_electron_all = new TH2F((string(hist_title)+"bc_width2_electron_all").c_str(), "Zee NO Requirement;Width 2^{nd} Samp;Likelihood by NN     ", 100, -.02, .06, 100, -1.00, 1.00);
   corr_width2_out_bc_electron_all->SetOption("COLZ");

   // Electrons loose:
   corr_bc_folder->mkdir("Zee_loose");
   corr_bc_folder->cd("Zee_loose");
   TH2F *corr_rcore_out_bc_electron_loose = new TH2F((string(hist_title)+"bc_rcore_electron_loose").c_str(), "Zee Loose;rCore;Likelihood by NN     ", 100, 0., 1.2, 100, -1.00, 1.00);
   corr_rcore_out_bc_electron_loose->SetOption("COLZ");
   TH2F *corr_eratio_out_bc_electron_loose = new TH2F((string(hist_title)+"bc_eratio_electron_loose").c_str(), "Zee Loose;eRatio;Likelihood by NN     ", 100, 0., 1.02, 100, -1.00, 1.00);
   corr_eratio_out_bc_electron_loose->SetOption("COLZ");
   TH2F *corr_eoverp_out_bc_electron_loose = new TH2F((string(hist_title)+"bc_eoverp_electron_loose").c_str(), "Zee Loose;#frac{E}{p};Likelihood by NN     ", 100, 0., 4., 100, -1.00, 1.00);
   corr_eoverp_out_bc_electron_loose->SetOption("COLZ");
   TH2F *corr_hadleakage_out_bc_electron_loose = new TH2F((string(hist_title)+"bc_hadleakage_electron_loose").c_str(), "Zee Loose;1^{st} Samp HAD Leakage;Likelihood by NN     ", 100, -250, 250, 100, -1.00, 1.00);
   corr_hadleakage_out_bc_electron_loose->SetOption("COLZ");
   TH2F *corr_width1_out_bc_electron_loose = new TH2F((string(hist_title)+"bc_width1_electron_loose").c_str(), "Zee Loose;Width 1^{st} Samp;Likelihood by NN     ", 100, .0, 1., 100, -1.00, 1.00);
   corr_width1_out_bc_electron_loose->SetOption("COLZ");
   TH2F *corr_width2_out_bc_electron_loose = new TH2F((string(hist_title)+"bc_width2_electron_loose").c_str(), "Zee Loose;Width 2^{nd} Samp;Likelihood by NN     ", 100, -.02, .06, 100, -1.00, 1.00);
   corr_width2_out_bc_electron_loose->SetOption("COLZ");

   // Electrons medium:
   corr_bc_folder->mkdir("Zee_medium");
   corr_bc_folder->cd("Zee_medium");
   TH2F *corr_rcore_out_bc_electron_medium = new TH2F((string(hist_title)+"bc_rcore_electron_medium").c_str(), "Zee Medium;rCore;Likelihood by NN     ", 100, 0., 1.2, 100, -1.00, 1.00);
   corr_rcore_out_bc_electron_medium->SetOption("COLZ");
   TH2F *corr_eratio_out_bc_electron_medium = new TH2F((string(hist_title)+"bc_eratio_electron_medium").c_str(), "Zee Medium;eRatio;Likelihood by NN     ", 100, 0., 1.02, 100, -1.00, 1.00);
   corr_eratio_out_bc_electron_medium->SetOption("COLZ");
   TH2F *corr_eoverp_out_bc_electron_medium = new TH2F((string(hist_title)+"bc_eoverp_electron_medium").c_str(), "Zee Medium;#frac{E}{p};Likelihood by NN     ", 100, 0., 4., 100, -1.00, 1.00);
   corr_eoverp_out_bc_electron_medium->SetOption("COLZ");
   TH2F *corr_hadleakage_out_bc_electron_medium = new TH2F((string(hist_title)+"bc_hadleakage_electron_medium").c_str(), "Zee Medium;1^{st} Samp HAD Leakage;Likelihood by NN     ", 100, -250, 250, 100, -1.00, 1.00);
   corr_hadleakage_out_bc_electron_medium->SetOption("COLZ");
   TH2F *corr_width1_out_bc_electron_medium = new TH2F((string(hist_title)+"bc_width1_electron_medium").c_str(), "Zee Medium;Width 1^{st} Samp;Likelihood by NN     ", 100, .0, 1., 100, -1.00, 1.00);
   corr_width1_out_bc_electron_medium->SetOption("COLZ");
   TH2F *corr_width2_out_bc_electron_medium = new TH2F((string(hist_title)+"bc_width2_electron_medium").c_str(), "Zee Medium;Width 2^{nd} Samp;Likelihood by NN     ", 100, -.02, .06, 100, -1.00, 1.00);
   corr_width2_out_bc_electron_medium->SetOption("COLZ");

   // Electrons tight:
   corr_bc_folder->mkdir("Zee_tight");
   corr_bc_folder->cd("Zee_tight");
   TH2F *corr_rcore_out_bc_electron_tight = new TH2F((string(hist_title)+"bc_rcore_electron_tight").c_str(), "Zee Tight;rCore;Likelihood by NN     ", 100, 0., 1.2, 100, -1.00, 1.00);
   corr_rcore_out_bc_electron_tight->SetOption("COLZ");
   TH2F *corr_eratio_out_bc_electron_tight = new TH2F((string(hist_title)+"bc_eratio_electron_tight").c_str(), "Zee Tight;eRatio;Likelihood by NN     ", 100, 0., 1.02, 100, -1.00, 1.00);
   corr_eratio_out_bc_electron_tight->SetOption("COLZ");
   TH2F *corr_eoverp_out_bc_electron_tight = new TH2F((string(hist_title)+"bc_eoverp_electron_tight").c_str(), "Zee Tight;#frac{E}{p};Likelihood by NN     ", 100, 0., 4., 100, -1.00, 1.00);
   corr_eoverp_out_bc_electron_tight->SetOption("COLZ");
   TH2F *corr_hadleakage_out_bc_electron_tight = new TH2F((string(hist_title)+"bc_hadleakage_electron_tight").c_str(), "Zee Tight;1^{st} Samp HAD Leakage;Likelihood by NN     ", 100, -250, 250, 100, -1.00, 1.00);
   corr_hadleakage_out_bc_electron_tight->SetOption("COLZ");
   TH2F *corr_width1_out_bc_electron_tight = new TH2F((string(hist_title)+"bc_width1_electron_tight").c_str(), "Zee Tight;Width 1^{st} Samp;Likelihood by NN     ", 100, .0, 1., 100, -1.00, 1.00);
   corr_width1_out_bc_electron_tight->SetOption("COLZ");
   TH2F *corr_width2_out_bc_electron_tight = new TH2F((string(hist_title)+"bc_width2_electron_tight").c_str(), "Zee Tight;Width 2^{nd} Samp;Likelihood by NN     ", 100, -.02, .06, 100, -1.00, 1.00);
   corr_width2_out_bc_electron_tight->SetOption("COLZ");

   // Jets with no requirement:
   corr_bc_folder->mkdir("JetTauMiss_noreq");
   corr_bc_folder->cd("JetTauMiss_noreq");
   TH2F *corr_rcore_out_bc_jet_all = new TH2F((string(hist_title)+"bc_rcore_jet_noreq").c_str(), "JetTauMiss NO Requirement;rCore;Likelihood by NN     ", 100, 0., 1.2, 100, -1.00, 1.00);
   corr_rcore_out_bc_jet_all->SetOption("COLZ");
   TH2F *corr_eratio_out_bc_jet_all = new TH2F((string(hist_title)+"bc_eratio_jet_noreq").c_str(), "JetTauMiss NO Requirement;eRatio;Likelihood by NN     ", 100, 0., 1.02, 100, -1.00, 1.00);
   corr_eratio_out_bc_jet_all->SetOption("COLZ");
   TH2F *corr_eoverp_out_bc_jet_all = new TH2F((string(hist_title)+"bc_eoverp_jet_noreq").c_str(), "JetTauMiss NO Requirement;#frac{E}{p};Likelihood by NN     ", 100, 0., 4., 100, -1.00, 1.00);
   corr_eoverp_out_bc_jet_all->SetOption("COLZ");
   TH2F *corr_hadleakage_out_bc_jet_all = new TH2F((string(hist_title)+"bc_hadleakage_jet_noreq").c_str(), "JetTauMiss NO Requirement;1^{st} Samp HAD Leakage;Likelihood by NN     ", 100, -250, 250, 100, -1.00, 1.00);
   corr_hadleakage_out_bc_jet_all->SetOption("COLZ");
   TH2F *corr_width1_out_bc_jet_all = new TH2F((string(hist_title)+"bc_width1_jet_noreq").c_str(), "JetTauMiss NO Requirement;Width 1^{st} Samp;Likelihood by NN     ", 100, .0, 1., 100, -1.00, 1.00);
   corr_width1_out_bc_jet_all->SetOption("COLZ");
   TH2F *corr_width2_out_bc_jet_all = new TH2F((string(hist_title)+"bc_width2_jet_noreq").c_str(), "JetTauMiss NO Requirement;Width 2^{nd} Samp;Likelihood by NN     ", 100, -.02, .06, 100, -1.00, 1.00);
   corr_width2_out_bc_jet_all->SetOption("COLZ");

   // Jets loose:
   corr_bc_folder->mkdir("JetTauMiss_loose");
   corr_bc_folder->cd("JetTauMiss_loose");
   TH2F *corr_rcore_out_bc_jet_loose = new TH2F((string(hist_title)+"bc_rcore_jet_loose").c_str(), "JetTauMiss Loose;rCore;Likelihood by NN     ", 100, 0., 1.2, 100, -1.00, 1.00);
   corr_rcore_out_bc_jet_loose->SetOption("COLZ");
   TH2F *corr_eratio_out_bc_jet_loose = new TH2F((string(hist_title)+"bc_eratio_jet_loose").c_str(), "JetTauMiss Loose;eRatio;Likelihood by NN     ", 100, 0., 1.02, 100, -1.00, 1.00);
   corr_eratio_out_bc_jet_loose->SetOption("COLZ");
   TH2F *corr_eoverp_out_bc_jet_loose = new TH2F((string(hist_title)+"bc_eoverp_jet_loose").c_str(), "JetTauMiss Loose;#frac{E}{p};Likelihood by NN     ", 100, 0., 4., 100, -1.00, 1.00);
   corr_eoverp_out_bc_jet_loose->SetOption("COLZ");
   TH2F *corr_hadleakage_out_bc_jet_loose = new TH2F((string(hist_title)+"bc_hadleakage_jet_loose").c_str(), "JetTauMiss Loose;1^{st} Samp HAD Leakage;Likelihood by NN     ", 100, -250, 250, 100, -1.00, 1.00);
   corr_hadleakage_out_bc_jet_loose->SetOption("COLZ");
   TH2F *corr_width1_out_bc_jet_loose = new TH2F((string(hist_title)+"bc_width1_jet_loose").c_str(), "JetTauMiss Loose;Width 1^{st} Samp;Likelihood by NN     ", 100, .0, 1., 100, -1.00, 1.00);
   corr_width1_out_bc_jet_loose->SetOption("COLZ");
   TH2F *corr_width2_out_bc_jet_loose = new TH2F((string(hist_title)+"bc_width2_jet_loose").c_str(), "JetTauMiss Loose;Width 2^{nd} Samp;Likelihood by NN     ", 100, -.02, .06, 100, -1.00, 1.00);
   corr_width2_out_bc_jet_loose->SetOption("COLZ");

   // Jets medium:
   corr_bc_folder->mkdir("JetTauMiss_medium");
   corr_bc_folder->cd("JetTauMiss_medium");
   TH2F *corr_rcore_out_bc_jet_medium = new TH2F((string(hist_title)+"bc_rcore_jet_medium").c_str(), "JetTauMiss Medium;rCore;Likelihood by NN     ", 100, 0., 1.2, 100, -1.00, 1.00);
   corr_rcore_out_bc_jet_medium->SetOption("COLZ");
   TH2F *corr_eratio_out_bc_jet_medium = new TH2F((string(hist_title)+"bc_eratio_jet_medium").c_str(), "JetTauMiss Medium;eRatio;Likelihood by NN     ", 100, 0., 1.02, 100, -1.00, 1.00);
   corr_eratio_out_bc_jet_medium->SetOption("COLZ");
   TH2F *corr_eoverp_out_bc_jet_medium = new TH2F((string(hist_title)+"bc_eoverp_jet_medium").c_str(), "JetTauMiss Medium;#frac{E}{p};Likelihood by NN     ", 100, 0., 4., 100, -1.00, 1.00);
   corr_eoverp_out_bc_jet_medium->SetOption("COLZ");
   TH2F *corr_hadleakage_out_bc_jet_medium = new TH2F((string(hist_title)+"bc_hadleakage_jet_medium").c_str(), "JetTauMiss Medium;1^{st} Samp HAD Leakage;Likelihood by NN     ", 100, -250, 250, 100, -1.00, 1.00);
   corr_hadleakage_out_bc_jet_medium->SetOption("COLZ");
   TH2F *corr_width1_out_bc_jet_medium = new TH2F((string(hist_title)+"bc_width1_jet_medium").c_str(), "JetTauMiss Medium;Width 1^{st} Samp;Likelihood by NN     ", 100, .0, 1., 100, -1.00, 1.00);
   corr_width1_out_bc_jet_medium->SetOption("COLZ");
   TH2F *corr_width2_out_bc_jet_medium = new TH2F((string(hist_title)+"bc_width2_jet_medium").c_str(), "JetTauMiss Medium;Width 2^{nd} Samp;Likelihood by NN     ", 100, -.02, .06, 100, -1.00, 1.00);
   corr_width2_out_bc_jet_medium->SetOption("COLZ");

   // Jets tight:
   corr_bc_folder->mkdir("JetTauMiss_tight");
   corr_bc_folder->cd("JetTauMiss_tight");
   TH2F *corr_rcore_out_bc_jet_tight = new TH2F((string(hist_title)+"bc_rcore_jet_tight").c_str(), "JetTauMiss Tight;rCore;Likelihood by NN     ", 100, 0., 1.2, 100, -1.00, 1.00);
   corr_rcore_out_bc_jet_tight->SetOption("COLZ");
   TH2F *corr_eratio_out_bc_jet_tight = new TH2F((string(hist_title)+"bc_eratio_jet_tight").c_str(), "JetTauMiss Tight;eRatio;Likelihood by NN     ", 100, 0., 1.02, 100, -1.00, 1.00);
   corr_eratio_out_bc_jet_tight->SetOption("COLZ");
   TH2F *corr_eoverp_out_bc_jet_tight = new TH2F((string(hist_title)+"bc_eoverp_jet_tight").c_str(), "JetTauMiss Tight;#frac{E}{p};Likelihood by NN     ", 100, 0., 4., 100, -1.00, 1.00);
   corr_eoverp_out_bc_jet_tight->SetOption("COLZ");
   TH2F *corr_hadleakage_out_bc_jet_tight = new TH2F((string(hist_title)+"bc_hadleakage_jet_tight").c_str(), "JetTauMiss Tight;1^{st} Samp HAD Leakage;Likelihood by NN     ", 100, -250, 250, 100, -1.00, 1.00);
   corr_hadleakage_out_bc_jet_tight->SetOption("COLZ");
   TH2F *corr_width1_out_bc_jet_tight = new TH2F((string(hist_title)+"bc_width1_jet_tight").c_str(), "JetTauMiss Tight;Width 1^{st} Samp;Likelihood by NN     ", 100, .0, 1., 100, -1.00, 1.00);
   corr_width1_out_bc_jet_tight->SetOption("COLZ");
   TH2F *corr_width2_out_bc_jet_tight = new TH2F((string(hist_title)+"bc_width_jet_tight").c_str(), "JetTauMiss Tight;Width 2^{nd} Samp;Likelihood by NN     ", 100, -.02, .06, 100, -1.00, 1.00);
   ...
   // All data with no requirement (general situation):
   corr_ac_folder->mkdir("Zee_JetTauMiss");
   corr_ac_folder->cd("Zee_JetTauMiss");
   TH2F *corr_rcore_out_ac_all = new TH2F((string(hist_title)+"ac_rcore_all").c_str(), "Zee + JetTauMiss NO Requirement;rCore;Likelihood by NN     ", 100, 0., 1.2, 100, -1.00, 1.00);
   corr_rcore_out_ac_all->SetOption("COLZ");
   TH2F *corr_eratio_out_ac_all = new TH2F((string(hist_title)+"ac_eratio_all").c_str(), "Zee + JetTauMiss NO Requirement;eRatio;Likelihood by NN     ", 100, 0., 1.02, 100, -1.00, 1.00);
   corr_eratio_out_ac_all->SetOption("COLZ");
   TH2F *corr_eoverp_out_ac_all = new TH2F((string(hist_title)+"ac_eoverp_all").c_str(), "Zee + JetTauMiss NO Requirement;#frac{E}{p};Likelihood by NN     ", 100, 0., 4., 100, -1.00, 1.00);
   corr_eoverp_out_ac_all->SetOption("COLZ");
   TH2F *corr_hadleakage_out_ac_all = new TH2F((string(hist_title)+"ac_hadleakage_all").c_str(), "Zee + JetTauMiss NO Requirement;1^{st} Samp HAD Leakage;Likelihood by NN     ", 100, -250, 250, 100, -1.00, 1.00);
   corr_hadleakage_out_ac_all->SetOption("COLZ");
   TH2F *corr_width1_out_ac_all = new TH2F((string(hist_title)+"ac_width1_all").c_str(), "Zee + JetTauMiss NO Requirement;Width 1^{st} Samp;Likelihood by NN     ", 100, .0, 1., 100, -1.00, 1.00);
   corr_width1_out_ac_all->SetOption("COLZ");
   TH2F *corr_width2_out_ac_all = new TH2F((string(hist_title)+"ac_width2_all").c_str(), "Zee + JetTauMiss NO Requirement;Width 2^{nd} Samp;Likelihood by NN     ", 100, -.02, .06, 100, -1.00, 1.00);
   corr_width2_out_ac_all->SetOption("COLZ");
   // Electrons with no requirement:
   corr_ac_folder->mkdir("Zee_noreq");
   corr_ac_folder->cd("Zee_noreq");
   TH2F *corr_rcore_out_ac_electron_all = new TH2F((string(hist_title)+"ac_rcore_electron_noreq").c_str(), "Zee NO Requirement;rCore;Likelihood by NN     ", 100, 0., 1.2, 100, -1.00, 1.00);
   corr_rcore_out_ac_electron_all->SetOption("COLZ");
   TH2F *corr_eratio_out_ac_electron_all = new TH2F((string(hist_title)+"ac_eratio_electron_all").c_str(), "Zee NO Requirement;eRatio;Likelihood by NN     ", 100, 0., 1.02, 100, -1.00, 1.00);
   corr_eratio_out_ac_electron_all->SetOption("COLZ");
   TH2F *corr_eoverp_out_ac_electron_all = new TH2F((string(hist_title)+"ac_eoverp_electron_all").c_str(), "Zee NO Requirement;#frac{E}{p};Likelihood by NN     ", 100, 0., 4., 100, -1.00, 1.00);
   corr_eoverp_out_ac_electron_all->SetOption("COLZ");
   TH2F *corr_hadleakage_out_ac_electron_all = new TH2F((string(hist_title)+"ac_hadleakage_electron_all").c_str(), "Zee NO Requirement;1^{st} Samp HAD Leakage;Likelihood by NN     ", 100, -250, 250, 100, -1.00, 1.00);
   corr_hadleakage_out_ac_electron_all->SetOption("COLZ");
   TH2F *corr_width1_out_ac_electron_all = new TH2F((string(hist_title)+"ac_width1_electron_all").c_str(), "Zee NO Requirement;Width 1^{st} Samp;Likelihood by NN     ", 100, .0, 1., 100, -1.00, 1.00);
   corr_width1_out_ac_electron_all->SetOption("COLZ");
   TH2F *corr_width2_out_ac_electron_all = new TH2F((string(hist_title)+"ac_width2_electron_all").c_str(), "Zee NO Requirement;Width 2^{nd} Samp;Likelihood by NN     ", 100, -.02, .06, 100, -1.00, 1.00);
   corr_width2_out_ac_electron_all->SetOption("COLZ");

   // Electrons loose:
   corr_ac_folder->mkdir("Zee_loose");
   corr_ac_folder->cd("Zee_loose");
   TH2F *corr_rcore_out_ac_electron_loose = new TH2F((string(hist_title)+"ac_rcore_electron_loose").c_str(), "Zee Loose;rCore;Likelihood by NN     ", 100, 0., 1.2, 100, -1.00, 1.00);
   corr_rcore_out_ac_electron_loose->SetOption("COLZ");
   TH2F *corr_eratio_out_ac_electron_loose = new TH2F((string(hist_title)+"ac_eratio_electron_loose").c_str(), "Zee Loose;eRatio;Likelihood by NN     ", 100, 0., 1.02, 100, -1.00, 1.00);
   corr_eratio_out_ac_electron_loose->SetOption("COLZ");
   TH2F *corr_eoverp_out_ac_electron_loose = new TH2F((string(hist_title)+"ac_eoverp_electron_loose").c_str(), "Zee Loose;#frac{E}{p};Likelihood by NN     ", 100, 0., 4., 100, -1.00, 1.00);
   corr_eoverp_out_ac_electron_loose->SetOption("COLZ");
   TH2F *corr_hadleakage_out_ac_electron_loose = new TH2F((string(hist_title)+"ac_hadleakage_electron_loose").c_str(), "Zee Loose;1^{st} Samp HAD Leakage;Likelihood by NN     ", 100, -250, 250, 100, -1.00, 1.00);
   corr_hadleakage_out_ac_electron_loose->SetOption("COLZ");
   TH2F *corr_width1_out_ac_electron_loose = new TH2F((string(hist_title)+"ac_width1_electron_loose").c_str(), "Zee Loose;Width 1^{st} Samp;Likelihood by NN     ", 100, .0, 1., 100, -1.00, 1.00);
   corr_width1_out_ac_electron_loose->SetOption("COLZ");
   TH2F *corr_width2_out_ac_electron_loose = new TH2F((string(hist_title)+"ac_width2_electron_loose").c_str(), "Zee Loose;Width 2^{nd} Samp;Likelihood by NN     ", 100, -.02, .06, 100, -1.00, 1.00);
   corr_width2_out_ac_electron_loose->SetOption("COLZ");

   // Electrons medium:
   corr_ac_folder->mkdir("Zee_medium");
   corr_ac_folder->cd("Zee_medium");
   TH2F *corr_rcore_out_ac_electron_medium = new TH2F((string(hist_title)+"ac_rcore_electron_medium").c_str(), "Zee Medium;rCore;Likelihood by NN     ", 100, 0., 1.2, 100, -1.00, 1.00);
   corr_rcore_out_ac_electron_medium->SetOption("COLZ");
   TH2F *corr_eratio_out_ac_electron_medium = new TH2F(hist_title, "Zee Medium;eRatio;Likelihood by NN     ", 100, 0., 1.02, 100, -1.00, 1.00);
   corr_eratio_out_ac_electron_medium->SetOption("COLZ");
   TH2F *corr_eoverp_out_ac_electron_medium = new TH2F((string(hist_title)+"ac_eoverp_electron_medium").c_str(), "Zee Medium;#frac{E}{p};Likelihood by NN     ", 100, 0., 4., 100, -1.00, 1.00);
   corr_eoverp_out_ac_electron_medium->SetOption("COLZ");
   TH2F *corr_hadleakage_out_ac_electron_medium = new TH2F((string(hist_title)+"ac_hadleakage_electron_medium").c_str(), "Zee Medium;1^{st} Samp HAD Leakage;Likelihood by NN     ", 100, -250, 250, 100, -1.00, 1.00);
   corr_hadleakage_out_ac_electron_medium->SetOption("COLZ");
   TH2F *corr_width1_out_ac_electron_medium = new TH2F((string(hist_title)+"ac_width1_electron_medium").c_str(), "Zee Medium;Width 1^{st} Samp;Likelihood by NN     ", 100, .0, 1., 100, -1.00, 1.00);
   corr_width1_out_ac_electron_medium->SetOption("COLZ");
   TH2F *corr_width2_out_ac_electron_medium = new TH2F((string(hist_title)+"ac_width2_electron_medium").c_str(), "Zee Medium;Width 2^{nd} Samp;Likelihood by NN     ", 100, -.02, .06, 100, -1.00, 1.00);
   corr_width2_out_ac_electron_medium->SetOption("COLZ");

   // Electrons tight:
   corr_ac_folder->mkdir("Zee_tight");
   corr_ac_folder->cd("Zee_tight");
   TH2F *corr_rcore_out_ac_electron_tight = new TH2F((string(hist_title)+"ac_rcore_electron_tight").c_str(), "Zee Tight;rCore;Likelihood by NN     ", 100, 0., 1.2, 100, -1.00, 1.00);
   corr_rcore_out_ac_electron_tight->SetOption("COLZ");
   TH2F *corr_eratio_out_ac_electron_tight = new TH2F((string(hist_title)+"ac_eratio_electron_tight").c_str(), "Zee Tight;eRatio;Likelihood by NN     ", 100, 0., 1.02, 100, -1.00, 1.00);
   corr_eratio_out_ac_electron_tight->SetOption("COLZ");
   TH2F *corr_eoverp_out_ac_electron_tight = new TH2F((string(hist_title)+"ac_eoverp_electron_tight").c_str(), "Zee Tight;#frac{E}{p};Likelihood by NN     ", 100, 0., 4., 100, -1.00, 1.00);
   corr_eoverp_out_ac_electron_tight->SetOption("COLZ");
   TH2F *corr_hadleakage_out_ac_electron_tight = new TH2F((string(hist_title)+"ac_hadleakage_electron_tight").c_str(), "Zee Tight;1^{st} Samp HAD Leakage;Likelihood by NN     ", 100, -250, 250, 100, -1.00, 1.00);
   corr_hadleakage_out_ac_electron_tight->SetOption("COLZ");
   TH2F *corr_width1_out_ac_electron_tight = new TH2F((string(hist_title)+"ac_width1_electron_tight").c_str(), "Zee Tight;Width 1^{st} Samp;Likelihood by NN     ", 100, .0, 1., 100, -1.00, 1.00);
   corr_width1_out_ac_electron_tight->SetOption("COLZ");
   TH2F *corr_width2_out_ac_electron_tight = new TH2F((string(hist_title)+"ac_width2_electron_tight").c_str(), "Zee Tight;Width 2^{nd} Samp;Likelihood by NN     ", 100, -.02, .06, 100, -1.00, 1.00);
   corr_width2_out_ac_electron_tight->SetOption("COLZ");

   // Jets with no requirement:
   corr_ac_folder->mkdir("JetTauMiss_noreq");
   corr_ac_folder->cd("JetTauMiss_noreq");
   TH2F *corr_rcore_out_ac_jet_all = new TH2F((string(hist_title)+"ac_rcore_jet_noreq").c_str(), "JetTauMiss NO Requirement;rCore;Likelihood by NN     ", 100, 0., 1.2, 100, -1.00, 1.00);
   corr_rcore_out_ac_jet_all->SetOption("COLZ");
   TH2F *corr_eratio_out_ac_jet_all = new TH2F((string(hist_title)+"ac_eratio_jet_all").c_str(), "JetTauMiss NO Requirement;eRatio;Likelihood by NN     ", 100, 0., 1.02, 100, -1.00, 1.00);
   corr_eratio_out_ac_jet_all->SetOption("COLZ");
   TH2F *corr_eoverp_out_ac_jet_all = new TH2F((string(hist_title)+"ac_eoverp_jet_all").c_str(), "JetTauMiss NO Requirement;#frac{E}{p};Likelihood by NN     ", 100, 0., 4., 100, -1.00, 1.00);
   corr_eoverp_out_ac_jet_all->SetOption("COLZ");
   TH2F *corr_hadleakage_out_ac_jet_all = new TH2F((string(hist_title)+"ac_hadleakage_jet_all").c_str(), "JetTauMiss NO Requirement;1^{st} Samp HAD Leakage;Likelihood by NN     ", 100, -250, 250, 100, -1.00, 1.00);
   corr_hadleakage_out_ac_jet_all->SetOption("COLZ");
   TH2F *corr_width1_out_ac_jet_all = new TH2F((string(hist_title)+"ac_width1_jet_all").c_str(), "JetTauMiss NO Requirement;Width 1^{st} Samp;Likelihood by NN     ", 100, .0, 1., 100, -1.00, 1.00);
   corr_width1_out_ac_jet_all->SetOption("COLZ");
   TH2F *corr_width2_out_ac_jet_all = new TH2F((string(hist_title)+"ac_width2_jet_all").c_str(), "JetTauMiss NO Requirement;Width 2^{nd} Samp;Likelihood by NN     ", 100, -.02, .06, 100, -1.00, 1.00);
   corr_width2_out_ac_jet_all->SetOption("COLZ");

   // Jets loose:
   corr_ac_folder->mkdir("JetTauMiss_loose");
   corr_ac_folder->cd("JetTauMiss_loose");
   TH2F *corr_rcore_out_ac_jet_loose = new TH2F((string(hist_title)+"ac_rcore_jet_loose").c_str(), "JetTauMiss Loose;rCore;Likelihood by NN     ", 100, 0., 1.2, 100, -1.00, 1.00);
   corr_rcore_out_ac_jet_loose->SetOption("COLZ");
   TH2F *corr_eratio_out_ac_jet_loose = new TH2F((string(hist_title)+"ac_eratio_jet_loose").c_str(), "JetTauMiss Loose;eRatio;Likelihood by NN     ", 100, 0., 1.02, 100, -1.00, 1.00);
   corr_eratio_out_ac_jet_loose->SetOption("COLZ");
   TH2F *corr_eoverp_out_ac_jet_loose = new TH2F((string(hist_title)+"ac_eoverp_jet_loose").c_str(), "JetTauMiss Loose;#frac{E}{p};Likelihood by NN     ", 100, 0., 4., 100, -1.00, 1.00);
   corr_eoverp_out_ac_jet_loose->SetOption("COLZ");
   TH2F *corr_hadleakage_out_ac_jet_loose = new TH2F((string(hist_title)+"ac_hadleakage_jet_loose").c_str(), "JetTauMiss Loose;1^{st} Samp HAD Leakage;Likelihood by NN     ", 100, -250, 250, 100, -1.00, 1.00);
   corr_hadleakage_out_ac_jet_loose->SetOption("COLZ");
   TH2F *corr_width1_out_ac_jet_loose = new TH2F((string(hist_title)+"ac_width1_jet_loose").c_str(), "JetTauMiss Loose;Width 1^{st} Samp;Likelihood by NN     ", 100, .0, 1., 100, -1.00, 1.00);
   corr_width1_out_ac_jet_loose->SetOption("COLZ");
   TH2F *corr_width2_out_ac_jet_loose = new TH2F((string(hist_title)+"ac_width2_jet_loose").c_str(), "JetTauMiss Loose;Width 2^{nd} Samp;Likelihood by NN     ", 100, -.02, .06, 100, -1.00, 1.00);
   corr_width2_out_ac_jet_loose->SetOption("COLZ");

   // Jets medium:
   corr_ac_folder->mkdir("JetTauMiss_medium");
   corr_ac_folder->cd("JetTauMiss_medium");
   TH2F *corr_rcore_out_ac_jet_medium = new TH2F((string(hist_title)+"ac_rcore_jet_medium").c_str(), "JetTauMiss Medium;rCore;Likelihood by NN     ", 100, 0., 1.2, 100, -1.00, 1.00);
   corr_rcore_out_ac_jet_medium->SetOption("COLZ");
   TH2F *corr_eratio_out_ac_jet_medium = new TH2F((string(hist_title)+"ac_eratio_jet_medium").c_str(), "JetTauMiss Medium;eRatio;Likelihood by NN     ", 100, 0., 1.02, 100, -1.00, 1.00);
   corr_eratio_out_ac_jet_medium->SetOption("COLZ");
   TH2F *corr_eoverp_out_ac_jet_medium = new TH2F((string(hist_title)+"ac_eoverp_jet_medium").c_str(), "JetTauMiss Medium;#frac{E}{p};Likelihood by NN     ", 100, 0., 4., 100, -1.00, 1.00);
   corr_eoverp_out_ac_jet_medium->SetOption("COLZ");
   TH2F *corr_hadleakage_out_ac_jet_medium = new TH2F((string(hist_title)+"ac_hadleakage_jet_medium").c_str(), "JetTauMiss Medium;1^{st} Samp HAD Leakage;Likelihood by NN     ", 100, -250, 250, 100, -1.00, 1.00);
   corr_hadleakage_out_ac_jet_medium->SetOption("COLZ");
   TH2F *corr_width1_out_ac_jet_medium = new TH2F((string(hist_title)+"ac_width1_jet_medium").c_str(), "JetTauMiss Medium;Width 1^{st} Samp;Likelihood by NN     ", 100, .0, 1., 100, -1.00, 1.00);
   corr_width1_out_ac_jet_medium->SetOption("COLZ");
   TH2F *corr_width2_out_ac_jet_medium = new TH2F((string(hist_title)+"ac_width2_jet_medium").c_str(), "JetTauMiss Medium;Width 2^{nd} Samp;Likelihood by NN     ", 100, -.02, .06, 100, -1.00, 1.00);
   corr_width2_out_ac_jet_medium->SetOption("COLZ");

   // Jets tight:
   corr_ac_folder->mkdir("JetTauMiss_tight");
   corr_ac_folder->cd("JetTauMiss_tight");
   TH2F *corr_rcore_out_ac_jet_tight = new TH2F((string(hist_title)+"ac_rcore_jet_tight").c_str(), "JetTauMiss Tight;rCore;Likelihood by NN     ", 100, 0., 1.2, 100, -1.00, 1.00);
   corr_rcore_out_ac_jet_tight->SetOption("COLZ");
   TH2F *corr_eratio_out_ac_jet_tight = new TH2F((string(hist_title)+"ac_eratio_jet_tight").c_str(), "JetTauMiss Tight;eRatio;Likelihood by NN     ", 100, 0., 1.02, 100, -1.00, 1.00);
   corr_eratio_out_ac_jet_tight->SetOption("COLZ");
   TH2F *corr_eoverp_out_ac_jet_tight = new TH2F((string(hist_title)+"ac_eoverp_jet_tight").c_str(), "JetTauMiss Tight;#frac{E}{p};Likelihood by NN     ", 100, 0., 4., 100, -1.00, 1.00);
   corr_eoverp_out_ac_jet_tight->SetOption("COLZ");
   TH2F *corr_hadleakage_out_ac_jet_tight = new TH2F((string(hist_title)+"ac_hadleakage_jet_tight").c_str(), "JetTauMiss Tight;1^{st} Samp HAD Leakage;Likelihood by NN     ", 100, -250, 250, 100, -1.00, 1.00);
   corr_hadleakage_out_ac_jet_tight->SetOption("COLZ");
   TH2F *corr_width1_out_ac_jet_tight = new TH2F((string(hist_title)+"ac_width1_jet_tight").c_str(), "JetTauMiss Tight;Width 1^{st} Samp;Likelihood by NN     ", 100, .0, 1., 100, -1.00, 1.00);
   corr_width1_out_ac_jet_tight->SetOption("COLZ");
   TH2F *corr_width2_out_ac_jet_tight = new TH2F((string(hist_title)+"ac_width2_jet_tight").c_str(), "JetTauMiss Tight;Width 2^{nd} Samp;Likelihood by NN     ", 100, -.02, .06, 100, -1.00, 1.00);
   ...
   long isem;
   long loose = egammaPID::ElectronLoose, index_loose = 0;
   ...
   unsigned int index_loose_jet = 0, index_loose_jet_2 = 0, counter = 0;
#if DEBUG
...
#if NEWWAY
       ++counter;
       if ( (counter < (unsigned int)(1e6)) && (isem & loose) ) {
         ++index_loose_jet_2;
         if (((index_loose_jet_2)%6==1) || (((index_loose_jet_2)%6)==2) || (((index_loose_jet_2)%6)==3) || (((index_loose_jet_2)%6)==4))
           continue; // if it is loose and it isnt part of test group we dont include on analysis.
       }
   ...
   Double_t red[NRGBs]   = { 0.0, 0, 0.87, 1.00, 0.1 };               
   Double_t green[NRGBs] = { 0.0, 0.81, 1.00, 0.20, 0.0 };               
   Double_t blue[NRGBs]  = { 0.51, 1.00, 0.12, 0.0, 0.0 };               
   ...
   TLegend *nnoutput_legend_jets = new TLegend(.39,.66,.75,.89);
   ...
   gPad->SetLogy();
   gPad->SetGridy();
   TLine *decisionThreshold = new TLine(NNCut_medium,0.,NNCut_medium, nnoutput_stack_electrons->GetHistogram()->GetMaximum()  );
   decisionThreshold->SetLineStyle(kDashed);
   decisionThreshold->Draw();
   TLegend *nnoutput_legend_electrons = new TLegend(.39,.66,.75,.89);
   ...
   TH1F *caloRinger_optimal_eff_et = new TH1F(*caloRinger_optimal_dist_ele_et), *caloRinger_optimal_eff_eta = new TH1F(*caloRinger_optimal_dist_ele_eta), *caloRinger_optimal_eff_phi = new TH1F(*caloRinger_optimal_dist_ele_phi);
   ...
   TLegend *caloRinger_eff_legend = new TLegend(.69,.11,.99,.45);
   ...
   regularEgamma_medium_fa_et->GetYaxis()->SetTitle("Detection Rate ");
   regularEgamma_medium_fa_phi->GetXaxis()->SetTitle("#phi");
   regularEgamma_medium_fa_phi->GetYaxis()->SetTitle("Detection Rate ");
   regularEgamma_medium_fa_eta->GetXaxis()->SetTitle("#eta");
   regularEgamma_medium_fa_eta->GetYaxis()->SetTitle("Detection Rate ");
   ...
   regularEgamma_tight_fa_et->GetYaxis()->SetTitle("Detection Rate ");
   regularEgamma_tight_fa_phi->GetXaxis()->SetTitle("#phi");
   regularEgamma_tight_fa_phi->GetYaxis()->SetTitle("Detection Rate ");
   regularEgamma_tight_fa_eta->GetXaxis()->SetTitle("#eta");
   regularEgamma_tight_fa_eta->GetYaxis()->SetTitle("Detection Rate ");
   ...
   TLegend *regularEgamma_eff_legend = new TLegend(.69,.11,.99,.45);
   ...
   TLegend *comparison_loose_fa_legend = new TLegend(.11,.65,.45,.89);
   ...
   caloRinger_medium_fa_et->Draw("same");
   TLegend *comparison_medium_fa_legend = new TLegend(.11,.65,.45,.89);
   ...
   caloRinger_tight_fa_et->Draw("same");
   TLegend *comparison_tight_fa_legend = new TLegend(.11,.65,.45,.89);
   ...
   TLegend *comparison_loose_eff_legend = new TLegend(.59,.11,.99,.36);
   ...
   TLegend *comparison_medium_eff_legend = new TLegend(.59,.11,.99,.36);
   ...
   TLegend *comparison_tight_eff_legend = new TLegend(.59,.11,.99,.36);
   ...
   outFile->cd("/CorrelationPlots_BC/Zee_JetTauMiss");
   gSystem->cd("..");
   gSystem->mkdir("CorrelationPlots_BC/Zee_JetTauMiss",true);
   gSystem->cd("CorrelationPlots_BC/Zee_JetTauMiss");
   ...
   corr_width2_bc_all_cut.push_back(0.115);
   ...
   outFile->cd("/CorrelationPlots_BC/Zee_noreq");
   gSystem->cd("../..");
   gSystem->mkdir("CorrelationPlots_BC/Zee_noreq",true);
   gSystem->cd("CorrelationPlots_BC/Zee_noreq");
   ...
   corr_width2_bc_electrons_all_cut.push_back(0.115);
   ...
   outFile->cd("/CorrelationPlots_BC/Zee_loose");
   gSystem->cd("../..");
   gSystem->mkdir("CorrelationPlots_BC/Zee_loose",true);
   gSystem->cd("CorrelationPlots_BC/Zee_loose");
   ...
   corr_width2_bc_electrons_loose_cut.push_back(0.115);
   ...
   outFile->cd("/CorrelationPlots_BC/Zee_medium");
   gSystem->cd("../..");
   gSystem->mkdir("CorrelationPlots_BC/Zee_medium",true);
   gSystem->cd("CorrelationPlots_BC/Zee_medium");
   ...
   corr_width2_bc_electrons_medium_cut.push_back(0.115);
   ...
   outFile->cd("/CorrelationPlots_BC/Zee_tight");
   gSystem->cd("../..");
   gSystem->mkdir("CorrelationPlots_BC/Zee_tight",true);
   gSystem->cd("CorrelationPlots_BC/Zee_tight");
   ...
   corr_width2_bc_electrons_tight_cut.push_back(0.115);
   ...
   outFile->cd("/CorrelationPlots_BC/JetTauMiss_noreq");
   gSystem->cd("../..");
   gSystem->mkdir("CorrelationPlots_BC/JetTauMiss_noreq",true);
   gSystem->cd("CorrelationPlots_BC/JetTauMiss_noreq");
   ...
   corr_width2_bc_jet_all_cut.push_back(0.115);
   ...
   outFile->cd("/CorrelationPlots_BC/JetTauMiss_loose");
   gSystem->cd("../..");
   gSystem->mkdir("CorrelationPlots_BC/JetTauMiss_loose",true);
   gSystem->cd("CorrelationPlots_BC/JetTauMiss_loose");
   ...
   corr_width2_bc_jet_loose_cut.push_back(0.115);
   ...
   outFile->cd("/CorrelationPlots_BC/JetTauMiss_medium");
   gSystem->cd("../..");
   gSystem->mkdir("CorrelationPlots_BC/JetTauMiss_medium",true);
   gSystem->cd("CorrelationPlots_BC/JetTauMiss_medium");
   ...
   corr_width2_bc_jet_medium_cut.push_back(0.115);
   ...
   outFile->cd("/CorrelationPlots_BC/JetTauMiss_tight");
   gSystem->cd("../..");
   gSystem->mkdir("CorrelationPlots_BC/JetTauMiss_tight",true);
   gSystem->cd("CorrelationPlots_BC/JetTauMiss_tight");
   ...
   corr_width2_bc_jet_tight_cut.push_back(0.115);
   ...
   cout << "Generating correlation plots with bc_all data NO requirement" << endl;
   outFile->cd("/CorrelationPlots_AC/Zee_JetTauMiss");
   gSystem->cd("../..");
   gSystem->mkdir("CorrelationPlots_AC/Zee_JetTauMiss",true);
   gSystem->cd("CorrelationPlots_AC/Zee_JetTauMiss");
   ...
   corr_width2_ac_all_cut.push_back(0.115);
   ...
   outFile->cd("/CorrelationPlots_AC/Zee_noreq");
   gSystem->cd("../..");
   gSystem->mkdir("CorrelationPlots_AC/Zee_noreq",true);
   gSystem->cd("CorrelationPlots_AC/Zee_noreq");
   ...
   corr_width2_ac_electron_all_cut.push_back(0.115);
   ...
   outFile->cd("/CorrelationPlots_AC/Zee_loose");
   gSystem->cd("../..");
   gSystem->mkdir("CorrelationPlots_AC/Zee_loose",true);
   gSystem->cd("CorrelationPlots_AC/Zee_loose");
   ...
   corr_width2_ac_electron_loose_cut.push_back(0.115);
   ...
   outFile->cd("/CorrelationPlots_AC/Zee_medium");
   gSystem->cd("../..");
   gSystem->mkdir("CorrelationPlots_AC/Zee_medium",true);
   gSystem->cd("CorrelationPlots_AC/Zee_medium");
   ...
   corr_width2_ac_electron_medium_cut.push_back(0.115);
   ...
   outFile->cd("/CorrelationPlots_AC/Zee_tight");
   gSystem->cd("../..");
   gSystem->mkdir("CorrelationPlots_AC/Zee_tight",true);
   gSystem->cd("CorrelationPlots_AC/Zee_tight");
   ...
   corr_width2_ac_electron_tight_cut.push_back(0.115);
   ...
   outFile->cd("/CorrelationPlots_AC/JetTauMiss_noreq");
   gSystem->cd("../..");
   gSystem->mkdir("CorrelationPlots_AC/JetTauMiss_noreq",true);
   gSystem->cd("CorrelationPlots_AC/JetTauMiss_noreq");
   ...
   corr_width2_ac_jet_all_cut.push_back(0.115);
   ...
   outFile->cd("/CorrelationPlots_AC/JetTauMiss_loose");
   gSystem->cd("../..");
   gSystem->mkdir("CorrelationPlots_AC/JetTauMiss_loose",true);
   gSystem->cd("CorrelationPlots_AC/JetTauMiss_loose");
   ...
   corr_width2_ac_jet_loose_cut.push_back(0.115);
   ...
   outFile->cd("/CorrelationPlots_AC/JetTauMiss_medium");
   gSystem->cd("../..");
   gSystem->mkdir("CorrelationPlots_AC/JetTauMiss_medium",true);
   gSystem->cd("CorrelationPlots_AC/JetTauMiss_medium");
   ...
   corr_width2_ac_jet_medium_cut.push_back(0.115);
   ...
   outFile->cd("/CorrelationPlots_AC/JetTauMiss_tight");
   gSystem->cd("../..");
   gSystem->mkdir("CorrelationPlots_AC/JetTauMiss_tight",true);
   gSystem->cd("CorrelationPlots_AC/JetTauMiss_tight");
   ...
   corr_width2_ac_jet_tight_cut.push_back(0.115);
   ...
   roc->SetTitle("Zee versus JetTauEtMiss");
...
void draw_corr(TH2F* myCorr, const vector<float> *yDec, const char *hist_title, const char *stringName){
   ...
   myCorr->GetYaxis()->SetLabelOffset(0.001);
